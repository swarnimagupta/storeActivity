...
/**
 * Provides necessary meta information about the storeactivitiesaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.4
 */
public class StoreactivitiesaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(StoreactivitiesaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.acc.hmc.locales";
