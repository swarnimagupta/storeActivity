...
/**
 * This is the extension manager of the Storeactivitiesaddon extension.
 */
public class StoreactivitiesaddonManager extends GeneratedStoreactivitiesaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(StoreactivitiesaddonManager.class.getName());
	 ...
	 */
	public static StoreactivitiesaddonManager getInstance()
	{
		return (StoreactivitiesaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				StoreactivitiesaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StoreactivitiesaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of StoreactivitiesaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of StoreactivitiesaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of StoreactivitiesaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
