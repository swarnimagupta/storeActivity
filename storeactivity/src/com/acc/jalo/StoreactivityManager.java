...
import com.acc.constants.StoreactivityConstants;



/**
 * This is the extension manager of the Storeactivity extension.
 */
public class StoreactivityManager extends GeneratedStoreactivityManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(StoreactivityManager.class.getName());
	 ...
	 */
	public static StoreactivityManager getInstance()
	{
		return (StoreactivityManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				StoreactivityConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StoreactivityManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of StoreactivityManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of StoreactivityManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of StoreactivityManager called, current tenant: " + getTenant().getTenantID());
		}
	}
