...
/**
 * Provides necessary meta information about the storeactivity hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.4
 */
public class StoreactivityHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(StoreactivityHMCExtension.class.getName());
